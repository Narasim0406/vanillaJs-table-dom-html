...
var conf = [{
  ...
  Column: function Column(_ref) {
    var CheckInTime = _ref.CheckInTime;
    return (0, _moment.default)(CheckInTime).format("DD/MM/YYYY");
  },
  Merge: false
}, {
  HeaderName: "Time",
  Column: function Column(_ref2) {
    var CheckInTime = _ref2.CheckInTime,
        CheckOutTime = _ref2.CheckOutTime;
    var secs = (CheckOutTime - CheckInTime) / 1000;
    return secs / 60 + " Mins";
  },
  Merge: false
}];
...
function generateTableHead(table, data) {
  ...
  try {
    for (var _iterator = data[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      var text = document.createTextNode(key.HeaderName);
      th.appendChild(text);
      row.appendChild(th);
    }
  } catch (err) {
...
},{"./styles.css":"src/styles.css","moment":"node_modules/moment/moment.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
